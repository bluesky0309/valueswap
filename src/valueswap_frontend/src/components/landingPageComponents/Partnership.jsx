                ...
                <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-16 '>
                    {
                        LandingPageData.PaternshipPageData.PartnershipData.map((Company, index) => {
                            ...
                            return (
                                <div className='bg-gradient-to-r from-[#000211] to-[#091031] flex justify-around cursor-pointer rounded-lg border border-[#3D3F47] py-8 w-[44vw] md:w-[30vw] lg:w-[21vw] mx-auto mb-3 mt-1  items-center group' key={index}>
